...
const Home = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `${($$result.title = `<title>Serverless Svelte</title>`, "")}`, "")}
...
const About = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `${($$result.title = `<title>About | Serverless Svelte</title>`, "")}`, "")}
...
const Blog = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `${($$result.title = `<title>Blog | Serverless Svelte</title>`, "")}`, "")}
...
<ul>
  <li>
    ${validate_component(Link, "Link").$$render($$result, { to: "/blog/first" }, {}, { default: () => `Lorem ipsum dolor` })}
  </li>
  <li>
    ${validate_component(Link, "Link").$$render($$result, { to: "/blog/second" }, {}, { default: () => `Sed vulputate mi sit` })}
  </li>
  <li>
    ${validate_component(Link, "Link").$$render($$result, { to: "/blog/third" }, {}, {
		default: () => `Lectus magna fringilla urna`
	})}
  </li>
</ul>
...
/* src/routes/BlogPost.svelte generated by Svelte v3.18.1 */
...
const BlogPost = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	const posts = {
		first: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Id diam maecenas ultricies mi eget mauris pharetra et. Risus quis varius quam quisque id diam vel. Congue eu consequat ac felis donec. Elit ullamcorper dignissim cras tincidunt. ",
		second: "Sed vulputate mi sit amet mauris. Tincidunt arcu non sodales neque sodales ut etiam. Dui nunc mattis enim ut tellus. Et leo duis ut diam. Maecenas pharetra convallis posuere morbi leo urna molestie at. Nisl vel pretium lectus quam id leo in.",
		third: "Lectus magna fringilla urna porttitor rhoncus dolor purus non enim. Blandit cursus risus at ultrices mi tempus imperdiet nulla malesuada. Donec enim diam vulputate ut pharetra sit amet aliquam id. Nibh tellus molestie nunc non blandit massa enim. Accumsan tortor posuere ac ut consequat semper viverra nam. "
	};

	let post = posts[slug];
	if ($$props.location === void 0 && $$bindings.location && location !== void 0) $$bindings.location(location);

	return `${($$result.head += `${($$result.title = `<title>Blog Post | Serverless Svelte</title>`, "")}`, "")}
...
const App = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div>
    ${validate_component(Route, "Route").$$render($$result, { path: "blog/:slug", component: BlogPost }, {}, {})}
